...
const Search = (props: Props) => {
  ...
  return (
    <div className="search">
      ...
      <input onChange={e => onChangeHandler(e)} type="text" className="search-input" placeholder="search by account/transaction/layer"/>
      <button onClick={onClickHandler} className="search-button">search ></button>
    </div>
  )
};
