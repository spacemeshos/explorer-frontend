 ...
 * @export
 */
export var MalfeasanceServiceApiFetchParamCreator = function MalfeasanceServiceApiFetchParamCreator(configuration) {
  return {
    /**
     * 
     * @throws {RequiredError}
     */
    malfeasanceServiceList: function malfeasanceServiceList(body, options) {
      // verify required parameter 'body' is not null or undefined
      if (body === null || body === undefined) {
        throw new RequiredError('body', 'Required parameter body was null or undefined when calling malfeasanceServiceList.');
      }
      var localVarPath = "/spacemesh.v2alpha1.MalfeasanceService/List";
      var localVarUrlObj = url.parse(localVarPath, true);
      var localVarRequestOptions = Object.assign({}, {
        method: 'POST'
      }, options);
 ...
 * @export
 */
export var MalfeasanceServiceApi = function MalfeasanceServiceApi(configuration) {
  var fetch = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : portableFetch;
  var basePath = configuration && configuration.basePath || BASE_PATH;
  return {
    /**
     ...
     * @throws {RequiredError}
     */
    malfeasanceServiceList: function malfeasanceServiceList(body) {
      var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      var localVarFetchArgs = MalfeasanceServiceApiFetchParamCreator(configuration).malfeasanceServiceList(body, options);
      return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then(function (response) {
        if (response.status >= 200 && response.status < 300) {
          return response.json();
        } else {
